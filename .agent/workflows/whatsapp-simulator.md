---
description: Ativa o agente Whatsapp-simulator
---

# Ativação do Agente Whatsapp-simulator

**INSTRUÇÕES CRÍTICAS PARA O ANTIGRAVITY:**

1. Leia COMPLETAMENTE o arquivo `.antigravity/agents/whatsapp-simulator.md`
